...
- (void)query:(UIViewController*)parent
{
    ...
    // 선택 셋팅 사항
    [ad setOffset:CGPointMake(0, 0)];  // 광고의 오프셋을 결정한다. (Default 0.0)
    [ad setRefershInterval:0.0f];      // 광고 재요청 시간 간격을 설정한다. 15~60초 (Default : 20)
...
- (void)tadCore:(TadCore *)tadCore tadOnAdFailed:(TadErrorCode)errorCode {
    ...
    NSLog(@"tadCore adFailed:%zd", errorCode);
